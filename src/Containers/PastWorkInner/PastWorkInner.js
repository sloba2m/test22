  ...
  let content = [
    {
      ...
      visitLink: "https://elysioburgers.com/",
      paraChallenge:
        "Elysio Burgers needed to broaden their customer base and simplify the ordering process by creating an engaging and user-friendly website with an intuitive online ordering system, a visually appealing digital menu, and easy in-restaurant access to the menu via QR codes.",
      ...
      paraSolution:
        "The outcome of our digital overhaul resulted in a substantial enlargement of Elysio Burgers' customer base. The efficient online ordering system raised customer satisfaction levels and facilitated repeat orders. The enthralling digital menu attracted new patrons, with the premium images inspiring them to experiment with new menu items. The in-restaurant QR codes simplified the ordering process, enhancing the dining experience. The addition of customer reviews fortified trust in Elysio Burgers, solidifying its image as a high-quality, customer-oriented restaurant.",
      solutionImg: content1solution,
      recent: [data[2], data[1]],
    },
    {
      ...
      qr: "",
      headMain:
        "Showcase work and provide an easy-to-use appointment booking feature",
      tech: [techIcon1, techIcon2, techIcon3, techIcon4, techIcon5, techIcon6],
      visitLink: "https://medicalsymmetry.com/",
      paraChallenge:
        "Improve Medical Symmetry's online presence by effectively presenting their range of services and incorporating an intuitive appointment booking system into their website.",
      challengeImg1: content2challenge1,
      challengeImg2: content2challenge2,
      paraApproach:
        "Our strategy was centered on presenting Medical Symmetry's range of services in an engaging manner and improving user experience by integrating an efficient online booking system. We aimed to detail their services clearly and compellingly, making it easy for potential clients to understand what each procedure involves and how it can benefit them.",
      approachImg: content2approach,
      paraSolution:
        "Our comprehensive website revamp enhanced Medical Symmetry's online presence and service presentation. The clear and engaging descriptions of their services improved user understanding, leading to informed decision-making by potential clients. The intuitive online booking system elevated the user experience by enabling easy and quick appointment scheduling.",
      solutionImg: content2solution,
      recent: [data[0], data[2]],
    },
    {
      ...
      paraSolution:
        "The result was a tastefully designed website that marries functionality with aesthetics. The platform not only presents Brittney's enticing recipes through high-quality images but also ensures smooth navigation for the visitors.",
    ...
    },
    {
      ...
      visitLink: "https://www.spheresxs.com/",
      paraChallenge:
        "Sphere, a pioneering blockchain company, aimed to take a leap forward in the industry by developing a multi-chain launchpad that could support several major blockchains. The principal challenge was crafting a technologically advanced yet user-centric interface, enabling users to access and interact with these blockchains in a seamless and intuitive manner.",
      challengeImg1: content4challenge1,
      challengeImg2: content4challenge2,
      paraApproach:
        "With a focus on combining advanced technology with user-friendliness, our strategy hinged on utilizing React.js, renowned for its capability to create dynamic and responsive user interfaces, and web3, a technology instrumental in simplifying and securing blockchain interactions directly via the website.",
      approachImg: content4approach,
      paraSolution:
        "We delivered a robust, interactive website built using React.js, offering an engaging and smooth user experience. The interface, while aesthetically pleasing, excels in its efficiency, successfully accommodating both expert blockchain users and novices. The integration of web3 allowed users to interact securely with various supported blockchains directly on the website, taking usability and accessibility in the blockchain industry to new heights.",
              ...
              <Col md={12}>
                <div className="img-div main-img">
                  ...
                  <div className="heading">
                    <h3>
                      <a href={obj.visitLink} target="_blank">
                        Visit {obj.key.split("-").join(" ")} Website{" "}
                        <img src={ArrowRight} />
                      </a>
                    </h3>
                  </div>
