...
import Service6Icon from "../../assets/images/home/service5.svg";
import Service7Icon from "../../assets/images/home/service5.svg";
import Service8Icon from "../../assets/images/home/service5.svg";
import Service9Icon from "../../assets/images/home/service5.svg";
                      ...
                      <div className="service-border-div">
                        <div className="service-div">
                          <div className="icon-div">
                            <img
                              src={Service1Icon}
                              alt="Consultation and Requirement Gathering"
                            />
                          </div>
                          <div className="heading">
                            <article>
                        ...
                        <div className="service-div">
                          ...
                          <div className="text-div">
                            <ul>
                              ...
                              <li>
                                Content Integration and Interactive
                                Functionality
                              </li>
                        ...
                        <div className="service-div">
                          ...
                          <div className="text-div">
                            <ul>
                              ...
                              <li>
                                Seamless Integration and Engaging Interactions
                              </li>
                        ...
                        <div className="service-div">
                          ...
                          <div className="text-div">
                            <ul>
                              ...
                              <li>
                                Testing, UX Considerations, Documentation, and
                                Support
                              </li>
                            </ul>
                            <span>LEARN MORE</span>
          ...
          <Row className="align-items-center">
            <Col md={6}>
              <div className="heading">
                ...
                <h1>
                  Where <span className="span-2">stunning</span> custom{" "}
                  <span className="span-2">websites</span> are born.
                </h1>
              </div>
              <div className="text-div">
                <p>
...
>>>>>>> d816b66379a3deb7b2e8deeb16289c0b822ccbd3
            ...
            <Col md={6}>
              <div className="image-div text-right">
                <img
                  src={section3Img}
                  alt="Where stunning custom websites are born"
                />
              </div>
            </Col>
          </Row>
...
<<<<<<< HEAD
                    <div className="text-div">
                      <p>
                        ...
                        Antonio, empowering businesses with our digital
                        expertise. Our dedicated team is fueled by a passion for
                        excellence and a commitment to delivering results. From
                        website design and development to digital marketing
                        strategies, we tailor our services to your unique needs,
